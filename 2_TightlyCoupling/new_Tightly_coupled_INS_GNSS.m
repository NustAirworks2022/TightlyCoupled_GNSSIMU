function [out_profile,out_IMU_bias_est,out_clock,out_KF_SD,PickSubsetRes,RecClockBiasRes,out_MeasurementNoise_SD,out_Resi,InnovationRes,StdInnovationRes] =...
    new_Tightly_coupled_INS_GNSS(FilePath,old_time,old_est_r_eb_e,old_est_v_eb_e,...
...
for epoch = 2:no_epochs
    [out_profile,out_IMU_bias_est,old_time,out_clock,out_KF_SD,PickSubsetRes,old_est_r_eb_e,old_est_v_eb_e,old_est_C_b_e,est_IMU_bias,P_matrix,est_clock,time_last_GNSS,...
        GNSS_epoch,progress_epoch,progress_mark,RecClockBiasRes,InnovationRes,no_epochs] = epochStep(epoch,old_est_r_eb_e,old_est_v_eb_e,old_est_C_b_e,est_IMU_bias,P_matrix,est_clock,time_last_GNSS,...
        GNSS_epoch, IMU, GNSSObs, GNSS_config, TC_KF_config, L_ba_b,progress_epoch,progress_mark,rewind,bars,dots,RecClockBiasRes,InnovationRes,no_epochs,coord,MLS,...
        out_profile,out_IMU_bias_est,old_time,out_clock,out_KF_SD,PickSubsetRes);   
...
%%
function [out_profile,out_IMU_bias_est,old_time,out_clock,out_KF_SD,PickSubsetRes,old_est_r_eb_e,old_est_v_eb_e,old_est_C_b_e,est_IMU_bias,P_matrix,est_clock,time_last_GNSS,...
        GNSS_epoch,progress_epoch,progress_mark,RecClockBiasRes,InnovationRes,no_epochs] = epochStep(epoch,old_est_r_eb_e,old_est_v_eb_e,old_est_C_b_e,est_IMU_bias,P_matrix,est_clock,time_last_GNSS,...
        GNSS_epoch, IMU, GNSSObs, GNSS_config, TC_KF_config, L_ba_b,progress_epoch,progress_mark,rewind,bars,dots,RecClockBiasRes,InnovationRes,no_epochs,coord,MLS,...
        out_profile,out_IMU_bias_est,old_time,out_clock,out_KF_SD,PickSubsetRes)  
...
%                 disp(['Time' num2str(time) 'GNSSObs removed in RemoveOutlierGNSSObs section'])
    ...
    Rotation=[   -sin(est_L_b)*cos(est_lambda_b),-sin(est_L_b)*sin(est_lambda_b),cos(est_L_b);
                        -sin(est_lambda_b),cos(est_lambda_b),0;
                        cos(est_L_b)*cos(est_lambda_b),cos(est_L_b)*sin(est_lambda_b),sin(est_L_b)];
    NEU=Rotation*(out_profile(epoch,2:4)-coord)';
